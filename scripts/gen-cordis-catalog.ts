...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  InstallResult: 'marketplace installation result is owned by packages/host/plugin-registry/src/marketplace.ts',
  PluginInfo: 'installed plugin record is owned by packages/host/plugin-registry/src/index.ts',
  RegistryPlugin: 'marketplace registry record is owned by packages/host/plugin-registry/src/registry.ts',
  RegistrySearchResult: 'marketplace search result is owned by packages/host/plugin-registry/src/registry.ts',
